...
class SaveableFoodtruck(var averageReviewScore: Double, val isFavorited: Boolean, val allReviews: MutableList<Reviews>, name: String, model: String, latitude: Double, longitude: Double, menu: Menu? = null) : Foodtruck(name, model, latitude, longitude, menu)
